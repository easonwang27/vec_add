...
typedef struct {
	__I  unsigned int SYSTEMVER;            /* 0x00 SYSTEM ID and Revision Register */
	     unsigned int RESERVED0[1];         /* 0x04 ~ 0x07 Reserved */
	__I  unsigned int SYSTEMCFG[2];         /* 0x08 SYSTEM Configuration Register */
...
typedef struct {
	...
	__I  unsigned long long CCTLSTATUS;     /* 0x80 CCTL Status Register */
	     unsigned long long RESERVED;       /* 0x88 Reserved */
	...
	__I  unsigned long long TGTRDATA[4];    /* 0xB0 ~ 0xCF TGT Read Data 0 to 3 */
	     unsigned long long RESERVED1[38];  /* 0xD0 ~ 0x1FF Reserved */
	__I  unsigned long long HPMCNT[32];     /* 0x200 ~ 0x2FF TGT Read Data 0 to 3 */
}L2CACHE_RegDef;
...
#define L2CACHE_BASE            _IO_(0xE0500000)
#define PLIC_BASE               _IO_(0x00400000)
...
#define UART2_BASE              _IO_(0x00F05000)
...
#define AE350_L2CACHE           ((L2CACHE_RegDef *)  L2CACHE_BASE)
